...
from shopping_basket.errors import ProductNotFoundError, OutOfStockError, InsufficientStockError
...
PRODUCT = Product(id=PRODUCT_ID, name='product', price=5)
...
class ProductServiceShould(TestCase):
    ...
    def test_add_item_to_repository(self):
        ...
        self.stock_manager.update_stock.assert_called_once_with(stock=stock)
