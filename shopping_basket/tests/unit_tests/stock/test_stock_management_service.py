...
class TestStockManagementServiceShould:
    def test_add_stock_to_repository(
        self, mocked_stock_repository, stock_management_service
    ) -> None:
    ...
    def test_raise_error_when_reserving_more_stock_than_available(
        self, mocked_stock_repository, stock_management_service
    ) -> None:
        quantity = 7
        mocked_stock_repository.find_by_id.return_value = STOCK_VIDEO_BREAKING_BAD
    ...
    def test_update_stock_levels_for_items_purchased(
        self, event_handler, mocked_stock_repository, stock_management_service
    ) -> None:
    ...
    def test_increase_stock_levels_for_product(
        self, mocked_stock_repository, stock_management_service
    ) -> None:
