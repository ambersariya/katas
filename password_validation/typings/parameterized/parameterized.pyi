...
if PY3:
    ...
    string_types = ...
    bytes_type = ...
    def make_method(func, instance, type): # -> MethodType:
        ...
...
CompatArgSpec = ...
def getargspec(func): # -> CompatArgSpec:
    ...

def skip_on_empty_helper(*a, **kw):
    ...

def reapply_patches_if_need(func): # -> ((*args: Unknown, **kwargs: Unknown) -> Unknown) | Any:
    ...
    ...
    """ Represents a single parameter to a test case.
        ...
        Intended to be used as an argument to ``@parameterized``::
            ...
            def test_stuff(foo, bar=16):
                pass
        """
    def __new__(cls, *args, **kwargs): # -> _param:
        ...
...
def parameterized_argument_value_pairs(func, p): # -> list[tuple[Unknown]] | zip[tuple[Unknown, Unknown]]:
...
class parameterized:
    ...
    def __call__(self, test_func): # -> ((*a: Unknown, **kw: Unknown) -> NoReturn) | ((test_self: Unknown | None = None) -> Generator[Unknown, None, None]):
        ...
    ...
    @classmethod
    def expand(cls, input, name_func=..., doc_func=..., skip_on_empty=..., **legacy):
...
def parameterized_class(attrs, input_values=..., class_name_func=..., classname_func=...): # -> (base_class: Unknown) -> Unknown:
...
def get_class_name_suffix(params_dict): # -> str:
    ...

def default_class_name_func(cls, num, params_dict): # -> str:
    ...
