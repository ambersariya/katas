...
class PasswordValidatorShould(TestCase):
    ...
    def test_iteration_1(self, password: str, expected_num_violations: int):
        password_validator = (
        ...
        self.assertEqual(len(result.violations), expected_num_violations)
    ...
    def test_iteration_2_validation_2(
        self, password: str, expected_num_violations: int
    ):
        password_validator = (
            PasswordValidatorBuilder()
    ...
    def test_iteration_2_validation_3(
        self, password: str, expected_num_violations: int
    ):
        password_validator = (
            PasswordValidatorBuilder()
